...
!function (e) {
    ...
    function n(e) {
        function a(e, n) {
            ...
            if (s = s.slice(i, u + 1)) if (u = s.length, o && j && u > 15 && (e > S || e !== m(e)) && L(M, N, f.s * e), r = r - i - 1, r > z) f.c = f.e = null; else if (G > r) f.c = [f.e = 0]; else {
        ...
        function F(e, n, t, i) {
            ...
            if (o = e.c[0], s = e.e, null == n) h = r(e.c), h = 19 == i || 24 == i && k >= s ? f(h, s) : l(h, s); else if (e = U(new a(e), n, t), u = e.e, h = r(e.c), c = h.length, 19 == i || 24 == i && (u >= n || k >= u)) {
                for (; n > c; h += "0", c++) ;
                h = f(h, u)
        ...
        var C, M = 0, T = a.prototype, q = new a(1), P = 20, B = 4, k = -7, $ = 21, G = -1e7, z = 1e7, j = !0, H = x,
            V = !1, W = 1, J = 100, X = {
                decimalSeparator: ".",
                groupSeparator: ",",
                groupSize: 3,
                secondaryGroupSize: 0,
                fractionGroupSeparator: "В ",
                fractionGroupSize: 0
            };
        return a.another = n, a.ROUND_UP = 0, a.ROUND_DOWN = 1, a.ROUND_CEIL = 2, a.ROUND_FLOOR = 3, a.ROUND_HALF_UP = 4, a.ROUND_HALF_DOWN = 5, a.ROUND_HALF_EVEN = 6, a.ROUND_HALF_CEIL = 7, a.ROUND_HALF_FLOOR = 8, a.EUCLID = 9, a.config = function () {
            ...
            return function (i, o, u, s, f) {
                ...
                for (v = new a(x), N = v.c = [], c = i.e - o.e, x = u + c + 1, f || (f = O, c = t(i.e / y) - t(o.e / y), x = x / y | 0), h = 0; L[h] == (I[h] || 0); h++) ;
                if (L[h] > (I[h] || 0) && c--, 0 > x) N.push(1), g = !0; else {
                    for (E = I.length, F = L.length, h = 0, x += 2, p = m(f / (L[0] + 1)), p > 1 && (L = e(L, p, f), I = e(I, p, f), F = L.length, E = I.length), A = F, b = I.slice(0, F), S = b.length; F > S; b[S++] = 0) ;
                    _ = L.slice(), _.unshift(0), D = L[0], L[1] >= f / 2 && D++;
                    do {
                        if (p = 0, l = n(L, b, F, S), 0 > l) {
                            if (R = b[0], F != S && (R = R * f + (b[1] || 0)), p = m(R / D), p > 1) for (p >= f && (p = f - 1), d = e(L, p, f), w = d.length, S = b.length; 1 == n(d, b, w, S);) p--, r(d, w > F ? _ : L, w, f), w = d.length, l = 1; else 0 == p && (l = p = 1), d = L.slice(), w = d.length;
                            if (S > w && d.unshift(0), r(b, d, S, f), S = b.length, -1 == l) for (; n(L, b, F, S) < 1;) p++, r(b, S > F ? _ : L, S, f), S = b.length
                        } else 0 === l && (p++, b = [0]);
            ...
            var r, i, o, u, s, f, l, c, h, g, p, d, m, w, v, N = this, b = N.c, S = (M = 17, e = new a(e, n)).c;
            ...
            for (w = O, v = A, o = g; --o >= 0;) {
                for (r = 0, p = S[o] % v, d = S[o] / v | 0, s = l, u = o + s; u > o;) c = b[--s] % v, h = b[s] / v | 0, f = d * c + h * p, c = p * c + f % v * v + m[u] + r, r = (c / w | 0) + (f / v | 0) + d * h, m[u--] = c % w;
                m[u] = r
            }
    ...
    function s(e, n, t) {
        for (var r, i, o = [0], u = 0, s = e.length; s > u;) {
            ...
            for (o[r = 0] += b.indexOf(e.charAt(u++)); r < o.length; r++) o[r] > t - 1 && (null == o[r + 1] && (o[r + 1] = 0), o[r + 1] += o[r] / t | 0, o[r] %= t)
        }
        return o.reverse()
    }
    ...
    var a, h, g, p = /^-?(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, d = Math.ceil, m = Math.floor,
        ...
        b = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ$_", O = 1e14, y = 14, S = 9007199254740991,
